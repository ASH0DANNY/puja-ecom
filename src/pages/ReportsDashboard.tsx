...
import type { Report, SalesReport, InventoryReport, CustomerReport } from '../types/reports';
import {
    Chart as ChartJS,
    CategoryScale,
    LinearScale,
            ...
            <div className="mb-8">
                ...
                <div className="flex space-x-4 mb-4">
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg ${selectedReport === 'sales'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg ${selectedReport === 'inventory'
                            ? 'bg-primary text-white'
                            : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg ${selectedReport === 'customers'
                            ? 'bg-primary text-white'
                            : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                            }`}
                    >
...
const SalesReportSection = ({ dateRange }: { dateRange: { start: Date; end: Date } }) => {
...
const CustomerReportSection = ({ dateRange }: { dateRange: { start: Date; end: Date } }) => {
    // Mock data - replace with actual data from your backend
    const customerData: CustomerReport = {
        ...
        customerRetention: Array.from({ length: 6 }, (_, i) => ({
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="h-[300px]">
                    <Line data={retentionChartData} options={{ maintainAspectRatio: false }} />
                </div>
            </div>
