                ...
                <div className="bg-gray-50 rounded-lg">
                  ...
                  <div className="divide-y divide-gray-200">
                    {selectedOrder.items.map((item, index) => (
                      <div key={item.product.id || index} className="flex items-center text-sm px-6 py-4">
                        <div className="w-2/5">
                        ...
                        <div className="w-1/5 text-center">${item.priceAtOrder.toFixed(2)}</div>
                        <div className="w-1/5 text-center">{item.quantity}</div>
                        <div className="w-1/5 text-right">${(item.priceAtOrder * item.quantity).toFixed(2)}</div>
                      </div>
                    ))}
